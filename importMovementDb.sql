CREATE DATABASE  IF NOT EXISTS `movements-db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `movements-db`;
-- MySQL dump 10.13  Distrib 8.0.36, for Linux (x86_64)
--
-- Host: localhost    Database: movements-db
-- ------------------------------------------------------
...
CREATE TABLE `account` (
                          ...
                          CONSTRAINT `account_chk_1` CHECK ((`state` between 0 and 1)),
                          CONSTRAINT `account_chk_2` CHECK ((`type` between 0 and 1))
...
INSERT INTO `account` VALUES ('0dfce29d-ac55-4749-96eb-a898fcb19351','67890',0,565,0),('6238a11c-ef3f-455f-ae31-3b370d6ef712','67890',0,1303,1),('802fd05e-1323-4004-a2d7-db21eeb01879','12345',1,1000,1),('d1fbc9da-cc6c-4b16-a67a-3f656191058a','67890',0,1000,0),('e508e1e9-0450-4852-8cca-3cb7d28cd5b5','12345',0,1132,0);
...
CREATE TABLE `movement` (
                              ...
                              PRIMARY KEY (`id`),
                              KEY `FKk10u787s9re28fue9gdscb5kt` (`account_number`),
                              CONSTRAINT `FKk10u787s9re28fue9gdscb5kt` FOREIGN KEY (`account_number`) REFERENCES `account` (`account_number`),
                              CONSTRAINT `movement_chk_1` CHECK ((`type` between 0 and 1))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
